...
<?php include("../header.php");?>
	...
	<div class="container">
		...
		<div class="col-lg-12">
			...
			<a href="../Manuelproyecto/index.php"><button class="btn btn-danger text-left"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> OPEN</button></a>
            <hr>
		</div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
                                        <tr>
                                            ...
                                            <td>*******</td>
											<td width="4%"><button class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true">a</span></button></td>
