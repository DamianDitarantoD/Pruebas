            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="http://192.168.1.80/Proyectos/create.php" class="btn btn-success pull-right">Agregar</a>
                    </div>
                    <?php
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                           // echo "<a href='read.php?id=". $row['ID'] ."' title='Ver' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                                            ...
                                            echo "<a href='http://192.168.1.80/Proyectos/delete.php?id=". $row['ID'] ."' title='Borrar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
